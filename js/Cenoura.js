class Cenoura
{
 ...
 {
   this.load.image("ceu","assets/FCE.png");
 ...
 create()
 {
    ...
    var cenoura = this.add.sprite(220, 210,"grande", 27);
...
INICIO(){
  game.time.events.repeat(Phaser.Timer.SECOND * 1, 1, this.CE, this);
...
NO(){
  ...
  game.time.events.repeat(Phaser.Timer.SECOND * 0.7, 1, this.U, this);
}
U(){
  this.audio = new Audio();
  ...
  game.time.events.repeat(Phaser.Timer.SECOND * 0.7, 1, this.RA, this);
}
RA(){
  this.audio = new Audio();
