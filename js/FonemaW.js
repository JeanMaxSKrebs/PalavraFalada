class FonemaW
{
 ...
 create()
 {
    ...
    //var btnpermitir = this.add.text(200,150," PERMITIR");
      ...
      this.add.sprite(30, 200,"Quadrado");

      this.add.sprite(275, 230,"Quadrado");

      this.add.sprite(130, 380,"Quadrado");

      this.add.sprite(418, 380,"Quadrado");

      this.add.sprite(510, 200,"Quadrado");



      this.add.sprite(50, 220,"Kiwi");

      this.add.sprite(295, 250,"Wolverine");

      this.add.sprite(150, 400,"");

      this.add.sprite(438, 400,"");

      this.add.sprite(530, 220,"Wafer");
...
LetraW()
{
  this.audio = new Audio();
	this.audio.src = "assets/sons/Letra, W.mp3";
	this.audio.play();
